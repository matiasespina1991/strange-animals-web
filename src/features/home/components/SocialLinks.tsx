...
function SocialIconFill({
  ...
  return (
    <span className={['relative z-10 block', iconClassName].join(' ')}>
      ...
      <svg
        aria-hidden="true"
        className="absolute inset-0 block h-full w-full [clip-path:polygon(0_0,0_0,0_0,0_0)] transition-[clip-path] delay-300 duration-1000 ease-[cubic-bezier(0.2,0.02,0.12,1)] group-hover:[clip-path:polygon(0_0,170%_0,115%_260%,0_285%)] group-focus-visible:[clip-path:polygon(0_0,170%_0,115%_260%,0_285%)]"
        viewBox={viewBox}
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          ...
          >
            ...
            <stop offset="52%" stopColor={gradient.via} />
